...
def ui_top(img, words, sign, state, prog, t):
    ...
    ti="Mehak's Glasses"; tw2,_=tsz(ti,0.38)
...
def main():
    ...
    cv2.namedWindow("Mehak's Glasses", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Mehak's Glasses", 1280, 720)
    ...
    cv2.setMouseCallback("Mehak's Glasses",mouse_cb,[1280])
    ...
    while True:
        ...
        cv2.imshow("Mehak's Glasses",dark)
